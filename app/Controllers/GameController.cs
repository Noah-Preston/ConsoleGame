...
namespace escape_corona.Controllers
{
  class GameController : IGameController
  {
    ...
    public void Run()
    {
      ...
      string greeting = "You wake up in your friends bathroom the walls are covered in feces you must escape or die of shame, you forgot your phone somewhere in the house though and you can't leave without it!";
